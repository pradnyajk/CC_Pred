...
# xgboost_test <- xgb.DMatrix(data = as.matrix(TestData[,1:independent_variable_nos]), label=TestData$Type)
pred_test_xg_boost <- predict(xg_boost, testing_data[,1:independent_variable_nos])
